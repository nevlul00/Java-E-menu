package cz.pavi.ocka.el_jidelni_listek.server.controller;

import cz.pavi.ocka.el_jidelni_listek.common.WelcomeMessage;
...
public class WelcomeController {
     ...
     * to the server at the sub-url of '/welcome' (e.g. http://localhost:8080/El_jidelni_listek-server/welcome)
